...
if __name__ == "__main__":
  ...
  print(static_power_map[0].shape)

  output_tensor = model([static_power_map[0], dynamic_power_map[0], m1_congestion_map[0], m2_congestion_map[0], m3_congestion_map[0]])
